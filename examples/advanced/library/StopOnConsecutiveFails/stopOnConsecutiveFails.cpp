                          ...
                          bool &stop)
{
    ...
    const size_t critStopOnConsFails = 2;
    
    if (nullptr != iter)
    {
        // Fetch the success stats of Mads
        auto successStats = iter->getConstSuccessStats();
        size_t nbConsecutiveFails =  successStats.getStatsNbConsecutiveFail();
        
        // NOTE: improving the best infeasible point is a success.
        
        if (nbConsecutiveFails >= critStopOnConsFails)
        {
