...
#ifndef __NOMAD_4_6_RUNATTRIBUTESDEFINITIONQUADMODEL__
#define __NOMAD_4_6_RUNATTRIBUTESDEFINITIONQUADMODEL__
...
{ "QUAD_MODEL_SEARCH_DYNAMIC_ENABLE",  "bool",  "false",  " Dynamic enabling/disabling of Quad Model search based on success ",  " \n  \n . Dynamic enabling/disabling of Quad Model search based on success. \n  \n . After a full success we rarely have another one. \n   Let's deactivate for the next iteration. \n    \n . This is a simple, yet efficient strategy. \n  \n . Can work well with QP_SEARCH_DYNAMIC_ENABLE. \n  \n . Argument: bool \n  \n . Example: QUAD_MODEL_SEARCH_DYNAMIC_ENABLE yes \n  \n . Default: false\n\n",  "  basic mads quad model search model_search dynamic  "  , "true" , "true" , "true" },
{ "QUAD_MODEL_SEARCH_SIMPLE_MADS",  "bool",  "false",  " Quad model search using a simpler version of Mads ",  " \n  \n . Enable quad model search using a simpler version of Mads \n  \n . Example: QUAD_MODEL_SEARCH_SIMPLE_MADS yes \n  \n . Default: false\n\n",  "  basic mads quad model search model_search  "  , "true" , "true" , "true" },
{ "QUAD_MODEL_AND_LH_SEARCH",  "bool",  "false",  " Quad model and LH search ",  " \n . Add points to construct a better quad model \n  \n . Not implemented. Triggers exception if enabled. \n  \n . Default: false\n\n",  "  basic mads quad model lh latin hypercube sampling search model_search  "  , "true" , "true" , "true" },
{ "QUAD_MODEL_SLD_SEARCH",  "bool",  "false",  " Quad model (SLD) search ",  " \n  \n . MADS model search, using Sébastien Le Digabel quad models \n  \n . Argument: one boolean ('yes' or 'no') \n  \n . Disabled for more than 50 variables \n  \n . Example: QUAD_MODEL_SLD_SEARCH yes \n  \n . Default: false\n\n",  "  basic mads quad model search model_search  "  , "true" , "true" , "true" },
...
{ "QUAD_MODEL_OPTIMIZATION_MIN_TR_RADIUS",  "Double",  "1E-12",  " Min trust region radius for Quad model mads optim  ",  " \n  \n . Quad model standalone Mads optimization on quadratic models for constrained and \n   unconstrained problems \n    \n . Use a Model Based Trust Region algorithm to iterate. \n  \n . Minimum trust region radius is used as termination criterion. \n  \n . The parameter QUAD_MODEL_OPTIMIZATION_MIN_TR_RADIUS is 1E-12 by default \n  \n . Argument: Double \n  \n . Example: QUAD_MODEL_OPTIMIZATION_MIN_TR_RADIUS 1E-6 \n  \n . Default: 1E-12\n\n",  "  advanced sgtelib quadratic quad optimization programming qp trust region radius "  , "true" , "false" , "true" },
...
{ "DYNAMIC_SEARCH",  "bool",  "false",  " Dynamically enable/disable active simple search methods during run  ",  " \n  \n . NOT used for now. Tests have not shown efficiency. \n    \n . Arguments: boolean \n  \n . Default: false\n\n",  "  developer quadratic model search  "  , "true" , "true" , "true" } };
