...
{ "QP_SEARCH_DYNAMIC_ENABLE",  "bool",  "false",  " Dynamic enabling/disabling of QP search based on success ",  " \n  \n . Dynamic enabling/disabling of QP search based on success. \n  \n . After a full success we rarely have another one. \n   Let's deactivate for the next iteration. \n    \n . This is a simple, yet efficient strategy. \n  \n . Can work well with QUAD_MODEL_SEARCH_DYNAMIC_ENABLE. \n  \n . Argument: bool \n  \n . Example: QP_SEARCH_DYNAMIC_ENABLE yes \n  \n . Default: false\n\n",  "  advanced algorithm search quadratic quad model programming qp dynamic  "  , "true" , "true" , "true" },
