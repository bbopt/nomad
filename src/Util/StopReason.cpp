...
// Dictionary function for LHStopType
template<> DLL_UTIL_API std::map<NOMAD::CatMadsDOEStopType,std::string> & NOMAD::StopReason<NOMAD::CatMadsDOEStopType>::dict() const
{
    static std::map<NOMAD::CatMadsDOEStopType,std::string> dictionary = {
        {NOMAD::CatMadsDOEStopType::STARTED,"Started"},   // Set at the beginning of an EvaluatorControl Run
        {NOMAD::CatMadsDOEStopType::NO_POINTS_GENERATED, "No points generated by DOE"},
        {NOMAD::CatMadsDOEStopType::ALL_POINTS_EVALUATED,"No more points to evaluate"}
    };
    return dictionary;
}
...
// Returns true when CatMads DOE Sampling is complete, or no points generated
template<> DLL_UTIL_API bool NOMAD::StopReason<NOMAD::CatMadsDOEStopType>::checkTerminate() const
{
    switch ( _stopReason )
    {
        case NOMAD::CatMadsDOEStopType::ALL_POINTS_EVALUATED:
        case NOMAD::CatMadsDOEStopType::NO_POINTS_GENERATED:
            return true;
        case NOMAD::CatMadsDOEStopType::STARTED:
            return false;
        default:
            throw NOMAD::Exception ( __FILE__, __LINE__,"All stop types must be checked for algo terminate");
    }
...
template<> DLL_UTIL_API std::map<NOMAD::ModelStopType,std::string> & NOMAD::StopReason<NOMAD::ModelStopType>::dict() const
{
    static std::map<NOMAD::ModelStopType,std::string> dictionary = {
        ...
        {NOMAD::ModelStopType::MIN_TRUST_REGION_RADIUS,"Model Based Trust Region radius reached minimum"}
    };
    return dictionary;
}
...
template<> DLL_UTIL_API bool NOMAD::StopReason<NOMAD::ModelStopType>::checkTerminate() const
{
    switch ( _stopReason )
    {
        ...
        case NOMAD::ModelStopType::MIN_TRUST_REGION_RADIUS:
            return true;
        default:
            throw NOMAD::Exception ( __FILE__, __LINE__,"All stop types must be checked for algo terminate");
    }
