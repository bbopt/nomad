...
#ifndef __NOMAD_4_6_STOPREASON__
#define __NOMAD_4_6_STOPREASON__
...
/// Stop type for CatMads DOE
enum class CatMadsDOEStopType : int
{
    STARTED                 ,  ///< Started (no stop)
    NO_POINTS_GENERATED     ,  ///< No points generated by DOE
    ALL_POINTS_EVALUATED    ,  ///< No more points to evaluate
    LAST
};
...
enum class ModelStopType : int
{
    ...
    ALL_POINTS_EVALUATED     ,  ///< No more points to evaluate
    MIN_TRUST_REGION_RADIUS  ,  /// For ModelBase Trust Region only
    LAST
};
...
#endif // __NOMAD_4_6_STOPREASON__
