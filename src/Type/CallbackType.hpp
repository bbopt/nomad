...
enum class CallbackType
{
    ...
    EVAL_OPPORTUNISTIC_CHECK, ///< Called after each evaluation for a special opportunistic check for cancelling remaining queue evaluations (maybe not a success)
    ITER_OPPORTUNISTIC_CHECK, ///< Called after each evaluation for a special opportunistic check for cancelling remaining queue evaluations and iteration.
