...
#ifndef __NOMAD_4_6_RANDOMALGOMEGAITERATION__
#define __NOMAD_4_6_RANDOMALGOMEGAITERATION__

#include "../../Algos/MegaIteration.hpp"
#include "../../Algos/RandomAlgo/RandomAlgoIteration.hpp"

#include "../../nomad_nsbegin.hpp"

/// Class for RandomAlgo mega iteration.
/**
 * Manager for RandomAlgo iterations starts, runs and ends.
 * Steps:
 * - Generate points over simplices (start).
 * - Evaluate points (run)
 * - Post-processing (end)
 */
class RandomAlgoMegaIteration: public MegaIteration
{
protected:

    std::shared_ptr<RandomAlgoIteration> _randomAlgoIteration;
...
public:
     ...
     */
    explicit RandomAlgoMegaIteration(const Step* parentStep,
                              size_t k,
                              std::shared_ptr<BarrierBase> barrier,
                              SuccessType success)
    : MegaIteration(parentStep, k,barrier,success), _randomAlgoIteration(nullptr)
    {
        init();
    }
 ...
 */
std::ostream& operator<<(std::ostream& os, const RandomAlgoMegaIteration& megaIteration);

/// Get an MegaIteration values from a stream
std::istream& operator>>(std::istream& is, RandomAlgoMegaIteration& megaIteration);

#include "../../nomad_nsend.hpp"

#endif // __NOMAD_4_6_RANDOMALGOMEGAITERATION__
