...
#ifndef __NOMAD_4_6_RANDOMALGOINITIALIZATION__
#define __NOMAD_4_6_RANDOMALGOINITIALIZATION__
...
/// Class for Random algo initialization. Can be used as a template for other algo.
/**
 * Evaluate initial trial points (x0).
 * If x0 is not provided simply pass.
 */
class RandomAlgoInitialization: public Initialization, public IterationUtils
{
private:

    std::shared_ptr<AlgoStopReasons<RandomAlgoStopType>> _randomAlgoStopReason;
...
public:
     ...
     */
    explicit RandomAlgoInitialization(const Step* parentStep)
    ...
    /// Destructor
    virtual ~RandomAlgoInitialization() {}
...
#endif // __NOMAD_4_6_RANDOMALGOINITIALIZATION__
