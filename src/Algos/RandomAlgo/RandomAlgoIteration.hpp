...
#ifndef __NOMAD_4_6_RANDOMALGOITERATION__
#define __NOMAD_4_6_RANDOMALGOITERATION__

#include "../../Algos/Iteration.hpp"
#include "../../Algos/RandomAlgo/RandomAlgoRandom.hpp"
#include "../../Algos/RandomAlgo/RandomAlgoUpdate.hpp"
 ...
 */
class RandomAlgoIteration: public Iteration
{
private:
    ...
    std::unique_ptr<NOMAD::RandomAlgoUpdate> _randomAlgoUpdate;
    
protected:
    std::unique_ptr<NOMAD::RandomAlgoRandom> _randomAlgoRandom;
...
public:
     ...
     */
    explicit RandomAlgoIteration(const Step *parentStep,
...
#endif // __NOMAD_4_6_RANDOMALGOITERATION__
