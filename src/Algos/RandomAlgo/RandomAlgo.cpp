...
// Random algo specifics
#include "../../Algos/RandomAlgo/RandomAlgo.hpp"
#include "../../Algos/RandomAlgo/RandomAlgoInitialization.hpp"
#include "../../Algos/RandomAlgo/RandomAlgoMegaIteration.hpp"

void NOMAD::RandomAlgo::init()
{
    ...
    _initialization = std::make_unique<NOMAD::RandomAlgoInitialization>( this );
}

bool NOMAD::RandomAlgo::runImp()
{
    ...
    if ( ! _stopReasons->checkTerminate() )
    {
        ...
        NOMAD::RandomAlgoMegaIteration megaIteration(this, k, barrier,NOMAD::SuccessType::UNDEFINED);
        ...
        _refMegaIteration = std::make_shared<NOMAD::RandomAlgoMegaIteration>(this, k, barrier, _success);
