...
void NOMAD::RandomAlgoUpdate::init()
{
...
std::string NOMAD::RandomAlgoUpdate::getName() const
{
    return getAlgoName() + NOMAD::stepTypeToString(_stepType);
}

bool NOMAD::RandomAlgoUpdate::runImp()
{
    ...
    auto iter = getParentOfType<NOMAD::RandomAlgoIteration*>();
