...
void NOMAD::RandomAlgoInitialization::init()
{
    _randomAlgoStopReason = NOMAD::AlgoStopReasons<NOMAD::RandomAlgoStopType>::get( _stopReasons );
}


bool NOMAD::RandomAlgoInitialization::runImp()
{
    ...
    if (doContinue)
    {
        ...
        if ( ! doContinue )
            _randomAlgoStopReason->set(NOMAD::RandomAlgoStopType::INITIAL_FAILED);

    }
    return doContinue;
}

void NOMAD::RandomAlgoInitialization::startImp()
{
...
void NOMAD::RandomAlgoInitialization::endImp()
{
...
void NOMAD::RandomAlgoInitialization::generateTrialPointsImp()
{
