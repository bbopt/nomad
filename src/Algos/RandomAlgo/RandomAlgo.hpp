...
#ifndef __NOMAD_4_6_RANDOMALGO__
#define __NOMAD_4_6_RANDOMALGO__
 ...
 */
class RandomAlgo: public Algorithm
{
public:
    /// Constructor
    /**
     ...
     */
    explicit RandomAlgo(const Step* parentStep,
...
private:
    ...
    /**
     ...
     - Loop on RandomAlgoMegaIteration (start, run, end) until a stop reason to terminate is obtained.
...
#endif // __NOMAD_4_6_RANDOMALGO__
