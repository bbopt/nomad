...
void NOMAD::RandomAlgoIteration::init()
{
    setStepType(NOMAD::StepType::ITERATION);
    
    _randomAlgoRandom = std::make_unique<NOMAD::RandomAlgoRandom>(this);
    _randomAlgoUpdate = std::make_unique<NOMAD::RandomAlgoUpdate> (this);

}

void NOMAD::RandomAlgoIteration::startImp()
{
    ...
    _randomAlgoUpdate->start();
    bool updateSuccess = _randomAlgoUpdate->run();
    _randomAlgoUpdate->end();
...
bool NOMAD::RandomAlgoIteration::runImp()
{
