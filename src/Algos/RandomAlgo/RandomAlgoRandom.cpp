...
void NOMAD::RandomAlgoRandom::init()
{
    ...
    const NOMAD::RandomAlgoIteration * iter = getParentOfType<NOMAD::RandomAlgoIteration*>();
...
void NOMAD::RandomAlgoRandom::startImp()
{
...
bool NOMAD::RandomAlgoRandom::runImp()
{
...
void NOMAD::RandomAlgoRandom::generateTrialPointsImp()
{
