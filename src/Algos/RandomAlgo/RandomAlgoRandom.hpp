...
#ifndef __NOMAD_4_6_RANDOMALGORANDOM__
#define __NOMAD_4_6_RANDOMALGORANDOM__
 ...
 */
class RandomAlgoRandom: public Step, public IterationUtils
{
private:
...
public:
     ...
     */
    explicit RandomAlgoRandom(const Step* parentStep)
      : Step(parentStep),
...
private:
    ...
    /**
     Call RandomAlgoRandom::generateTrialPoints and update the trial points.
     */
...
#endif // __NOMAD_4_6_RANDOMALGORANDOM__
