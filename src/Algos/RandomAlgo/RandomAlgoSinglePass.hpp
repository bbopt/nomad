...
#ifndef __NOMAD_4_6_RANDOMALGOSINGLEPASS__
#define __NOMAD_4_6_RANDOMALGOSINGLEPASS__
 ...
 */
class RandomAlgoSinglePass: public RandomAlgoIteration, public IterationUtils
{
public:
    /// Constructor
    /**
     ...
     */
    explicit RandomAlgoSinglePass(const Step* parentStep,
                                    const EvalPointPtr center)
      : RandomAlgoIteration(parentStep, center, 0 ),
...
#endif // __NOMAD_4_6_RANDOMALGOSINGLEPASS__
