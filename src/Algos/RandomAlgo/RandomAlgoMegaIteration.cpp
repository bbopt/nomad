...
#include "../../Algos/RandomAlgo/RandomAlgoMegaIteration.hpp"
#include "../../Output/OutputQueue.hpp"


void NOMAD::RandomAlgoMegaIteration::init()
{
    ...
    // Create a random algo iteration.
    ...
    _randomAlgoIteration = std::make_shared<NOMAD::RandomAlgoIteration>(this,
...
void NOMAD::RandomAlgoMegaIteration::startImp()
{
    ...
    if ( ! _stopReasons->checkTerminate() )
    {
        ...
        OUTPUT_DEBUG_START
        auto frameCenter = _randomAlgoIteration->getFrameCenter();
...
bool NOMAD::RandomAlgoMegaIteration::runImp()
{
    ...
    if ( _randomAlgoIteration == nullptr )
    {
    ...
    if (! _stopReasons->checkTerminate())
    {
        _randomAlgoIteration->start();

        successful = _randomAlgoIteration->run();          // Is this iteration successful

        _randomAlgoIteration->end();
...
void NOMAD::RandomAlgoMegaIteration::display( std::ostream& os ) const
{
    NOMAD::MegaIteration::display(os);
}


void NOMAD::RandomAlgoMegaIteration::read(  std::istream& is )
{
...
std::ostream& NOMAD::operator<<(std::ostream& os, const NOMAD::RandomAlgoMegaIteration& megaIteration)
{
...
std::istream& NOMAD::operator>>(std::istream& is, NOMAD::RandomAlgoMegaIteration& megaIteration)
{
