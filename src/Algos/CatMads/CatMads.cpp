...
void NOMAD::CatMads::init()
{
    ...
    if (_catVG.empty())
    {
        NOMAD::Exception(__FILE__,__LINE__,"CatMads algo is called but no group of categorical variables is defined (CAT_GROUP).");
    }
    ...
    if (nullptr == evc)
    {
        NOMAD::Exception(__FILE__,__LINE__,"CatMads algo needs evaluator control.");
    }
