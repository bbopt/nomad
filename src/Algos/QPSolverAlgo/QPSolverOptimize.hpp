...
/*---------------------------------------------------------------------------------*/
#ifndef __NOMAD_4_4_QP_SOLVER_OPTIMIZE__
#define __NOMAD_4_4_QP_SOLVER_OPTIMIZE__
...
private:
    ...
    // Solve QP with bound-constraints with a basic active-set strategy.
    bool solveBCQP(NOMAD::Point & X, const int max_iter = 10, const double atol = 1E-7, const double rtol = 1E-7, bool verbose = false);
    ...
    void projectedGradient(SGTELIB::Matrix & X, const SGTELIB::Matrix & H, const SGTELIB::Matrix & g, const double g0, const SGTELIB::Matrix & lvar, const SGTELIB::Matrix & uvar, bool * active_l, bool * active_u, bool * working, SGTELIB::Matrix & d_k, SGTELIB::Matrix & Temp, const double tol = 1E-12, const int max_iter = 100, bool verbose = false);
    ...
    // Check wether working set is a subset of binding
    // If false, set the first encountered component to false in working.
    bool check_subset_binding_update(bool * working, const bool * binding, size_t n);

    // Compute a solution of {d \in argmin_d q(x + d) s.t. d_active = 0, \|d_free\|_2 <= Delta}
    void solve_TR_constrained_QP(SGTELIB::Matrix * d, const SGTELIB::Matrix & X, const SGTELIB::Matrix & H, const SGTELIB::Matrix & g, SGTELIB::Matrix & grad, const bool * active, const double Delta, bool verbose = false);
    ...
    void solve_unconstrained_QP(SGTELIB::Matrix * d, const SGTELIB::Matrix & X, const SGTELIB::Matrix & H, const SGTELIB::Matrix & g, SGTELIB::Matrix & grad, const bool * active) { return solve_TR_constrained_QP(d, X, H, g, grad, active, 1E15);}
    ...
    bool solveL1AugLag(NOMAD::Point & X, const int max_iter = 9, const double atol = 1E-7, const double rtol = 1E-7);
    ...
    double piecewise_line_search(const NOMAD::Point & X, const SGTELIB::Matrix & d, const bool * active, const bool * feasible, const bool * infeasible, const SGTELIB::Matrix & lambda, double mu, double small_gamma = 1E-20, double gamma_update = 1.5, double delta = 1E-4) const ;
    SGTELIB::Matrix get_pseudo_multiplier(const bool * active, const bool * feasible, const bool * infeasible, const SGTELIB::Matrix & lambda, double mu) const;
    bool compute_horizontal_step(const NOMAD::Point & X, SGTELIB::Matrix & h_k, const SGTELIB::Matrix &Jacobian_k, const bool * active, const bool * feasible, const bool * infeasible, const SGTELIB::Matrix & lambda_l, const double mu_l) const ;
    bool compute_vertical_step(const NOMAD::Point & X, SGTELIB::Matrix & v_k, const SGTELIB::Matrix &activeJacobian_k, const SGTELIB::Matrix &cons, const bool * active) const ;
    double check_inner_success(NOMAD::Point & X, const SGTELIB::Matrix & Jacobian_k, SGTELIB::Matrix & multiplier_k, const SGTELIB::Matrix & lambda, double mu, bool * active, bool * infeasible) const ;

// Algo 3.
// Augmented Lagrangian
    bool solveAugLag(NOMAD::Point & X, const int max_iter = 30, const double tolDistDX = -1.0, const double atol = 1E-7, const double rtol = 1E-7, const double mu0 = 0.5, const double muDecrease = 2.0, const double eta0 = 1.0, const double omega0 = 1.0, const double successRatio = 0.99, const size_t maxIterInner = 50, const double tolDistDXInner = 1E-15, const size_t maxSuccessivFail = 3);
    
    int solve_bound_AugLag(SGTELIB::Matrix & XSp, const SGTELIB::Matrix & XS, const SGTELIB::Matrix & lvar, const SGTELIB::Matrix & uvar, const SGTELIB::Matrix & lambda, double omega, double mu, SGTELIB::Matrix & GradPk, SGTELIB::Matrix & HessPk, const size_t maxIterInnerLoop = 50, const double tolerance_distDX = 1E-15, bool verbose = false) ;
...
// Augmented Lagrangian model getters
    double getAugLagModelObj(const SGTELIB::Matrix & XS, const SGTELIB::Matrix & lambda, double mu) const;
    double getAugLagModelObj(const SGTELIB::Matrix & XS, const SGTELIB::Matrix & cons, double fx, const SGTELIB::Matrix & lambda, double mu) const;
    SGTELIB::Matrix getAugLagModelGrad(const SGTELIB::Matrix & XS, const SGTELIB::Matrix & lambda, double mu) const;
    void getAugLagModelGrad(SGTELIB::Matrix * lagGrad, const SGTELIB::Matrix & XS, const SGTELIB::Matrix & lambda, double mu) const;
    SGTELIB::Matrix getAugLagModelHess(const SGTELIB::Matrix & XS, const SGTELIB::Matrix & lambda, double mu) const;
    void getAugLagModelHess(SGTELIB::Matrix * lagHess, const SGTELIB::Matrix & XS, const SGTELIB::Matrix & lambda, double mu) const;

// Algo 4. Trust region interior point
    bool solveTRIPM(NOMAD::Point & X, const int max_iter = 30, const double tolDistDX = -1.0, const double atol = 1E-7, const double rtol = 1E-7, const double mu0 = 0.5, const double muDecrease = 2.0, const size_t maxIterInner = 40, bool verbose = true, bool verbose_SolverBarrier = false);
    int solver_barrier(
        NOMAD::Point & X,
        SGTELIB::Matrix & XSp,
        SGTELIB::Matrix & p,
...
// Optimality functions
    ...
    double check_optimality_bounds(const SGTELIB::Matrix & X, const SGTELIB::Matrix & gradient,const SGTELIB::Matrix & lvar, const SGTELIB::Matrix & uvar) ;
    double check_optimality_bounds(const SGTELIB::Matrix & X, const SGTELIB::Matrix & gradient,const SGTELIB::Matrix & lvar, const SGTELIB::Matrix & uvar, SGTELIB::Matrix & dual_feas) ;
...
// Basic optimization functions
    ...
    bool ComputeNewtonDirection(const SGTELIB::Matrix g, int * pp, double ** D, double ** L, double * sol, int nfree) ;
    ...
    // Compute a in-place a solution of {d \in argmin_d q(x + d) s.t. d_active = 0, \|d_free\|_2 <= Delta} for convex quadratic
    bool Convex_TR_QP(SGTELIB::Matrix * d, const SGTELIB::Matrix & g, const SGTELIB::Matrix & gW, const SGTELIB::Matrix & H, const SGTELIB::Matrix & HW, int * pp, double ** D, double ** L, const bool * active, const double Delta, const bool verbose) ;
...
// Utils
    ...
    bool check_strict_feasible(const SGTELIB::Matrix & X, const SGTELIB::Matrix & lvar, const SGTELIB::Matrix & uvar) ;
    SGTELIB::Matrix vector_subset(const SGTELIB::Matrix & X, const bool * active) ;
    void vector_broadcast(SGTELIB::Matrix * X, const SGTELIB::Matrix & Xsub, const bool * active) ;
    SGTELIB::Matrix matrix_subset(const SGTELIB::Matrix & X, const bool * active) ;
    ...
    void project_bounds(SGTELIB::Matrix & d_k, bool * active) ;
...
#endif // __NOMAD_4_4_QP_SOLVER_OPTIMIZE__
