...
#ifndef __NOMAD_4_6_ADS__
#define __NOMAD_4_6_ADS__

#include "../../Algos/Mads/Mads.hpp"

#include "../../nomad_nsbegin.hpp"

/// The (A)daptive (D)irect (S)earch algorithm.
/**
 ...
 */
class DLL_ALGO_API Ads: public Mads
{
...
public:
     ...
     */
    explicit Ads(const Step* parentStep,
      ...
      : Mads(parentStep, stopReasons, runParams, pbParams, barrierInitializedFromCache, useOnlyLocalFixedVariables)
    {
        init();
    }
