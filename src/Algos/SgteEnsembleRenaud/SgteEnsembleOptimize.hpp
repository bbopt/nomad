...
/*---------------------------------------------------------------------------------*/
#ifndef __NOMAD400_SGTE_ENSEMBLE_OPTIMIZE__
#define __NOMAD400_SGTE_ENSEMBLE_OPTIMIZE__
...
class SgteEnsembleOptimize : public Step
{
private:
...
public:
    /// Constructor
    // Parent must explicitely be a (pointer to a) SgteEnsembleAlgo.
    // Run parameters will be recomputed for model optimization.
    explicit SgteEnsembleOptimize(const SgteEnsembleAlgo* modelAlgo,
...
#endif // __NOMAD400_SGTE_ENSEMBLE_OPTIMIZE__
