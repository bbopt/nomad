...
void NOMAD::SgteEnsembleOptimize::init()
{
...
void NOMAD::SgteEnsembleOptimize::startImp()
{
    ...
    s = "BBOT: " + NOMAD::BBOutputTypeListToString(NOMAD::SgteEnsembleAlgo::getBBOutputType());
    AddOutputInfo(s, _displayLevel);
    ...
    oss << "Run Parameters for SgteEnsembleOptimize:" << std::endl;
...
bool NOMAD::SgteEnsembleOptimize::runImp()
{
    ...
    else
    {
        ...
        {
            s = "Error: In SgteEnsembleOptimize, need a SgteEnsembleAlgo parent.";
            throw NOMAD::Exception(__FILE__, __LINE__, s);
        }

        auto ev = std::make_shared<NOMAD::SgteEnsembleEvaluator>(
        ...
        _mads->setName(_mads->getName() + " (SgteEnsembleOptimize)");
...
void NOMAD::SgteEnsembleOptimize::endImp()
{
}


void NOMAD::SgteEnsembleOptimize::setupRunParameters()
{
    ...
    _optRunParams->setAttributeValue("SGTE_ENSEMBLE_SEARCH", false);
    ...
    // No hMax in the context of SgteEnsembleAlgo
...
void NOMAD::SgteEnsembleOptimize::setupPbParameters(const NOMAD::ArrayOfDouble& lowerBound,
...
void NOMAD::SgteEnsembleOptimize::updateOraclePoints()
{
    _oraclePoints.clear();
