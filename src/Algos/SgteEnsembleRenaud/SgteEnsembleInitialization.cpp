...
void NOMAD::SgteEnsembleInitialization::init()
{
...
/*       Destructor        */
/*-------------------------*/
NOMAD::SgteEnsembleInitialization::~SgteEnsembleInitialization()
{
}


void NOMAD::SgteEnsembleInitialization::startImp()
{
}


bool NOMAD::SgteEnsembleInitialization::runImp()
{
...
void NOMAD::SgteEnsembleInitialization::endImp()
{
}


void NOMAD::SgteEnsembleInitialization::validateX0s() const
{
...
bool NOMAD::SgteEnsembleInitialization::eval_x0s()
{
    bool evalOk = false;
