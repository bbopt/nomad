...
#include "../../Algos/SgteEnsembleRenaud/SgteEnsembleUpdate.hpp"
#include "../../Output/OutputQueue.hpp"
#include "../../Type/SgtelibModelFeasibilityType.hpp"
#include "../../Type/SgtelibModelFormulationType.hpp"


NOMAD::SgteEnsembleUpdate::~SgteEnsembleUpdate()
{
}


void NOMAD::SgteEnsembleUpdate::init()
{
...
void NOMAD::SgteEnsembleUpdate::startImp()
{
...
// ancestor SgteEnsembleAlgo (modelAlgo).
//
...
bool NOMAD::SgteEnsembleUpdate::runImp()
{
    ...
    {
        s = "Error: In SgteEnsembleUpdate, need a SgteEnsembleAlgo parent.";
    ...
    size_t nbModels = NOMAD::SgteEnsembleAlgo::getNbModels(modelFeasibility, nbConstraints);
    ...
    auto megaIter = getParentOfType<NOMAD::SgteEnsembleMegaIteration*>();
    ...
    {
        OUTPUT_INFO_START
        s = "SgteEnsembleAlgo found " + std::to_string(nbValidPoints);
...
void NOMAD::SgteEnsembleUpdate::endImp()
{
}


bool NOMAD::SgteEnsembleUpdate::validForUpdate(const NOMAD::EvalPoint& evalPoint)
{
