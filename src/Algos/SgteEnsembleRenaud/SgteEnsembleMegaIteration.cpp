...
#include "../../Algos/SgteEnsembleRenaud/SgteEnsembleFilterCache.hpp"
#include "../../Algos/SgteEnsembleRenaud/SgteEnsembleIteration.hpp"
#include "../../Algos/SgteEnsembleRenaud/SgteEnsembleMegaIteration.hpp"
#include "../../Output/OutputQueue.hpp"


void NOMAD::SgteEnsembleMegaIteration::init()
{
    _name = NOMAD::MegaIteration::getName();
}


NOMAD::SgteEnsembleMegaIteration::~SgteEnsembleMegaIteration()
{
...
void NOMAD::SgteEnsembleMegaIteration::startImp()
{
...
bool NOMAD::SgteEnsembleMegaIteration::runImp()
{
...
void NOMAD::SgteEnsembleMegaIteration::endImp()
{
...
void NOMAD::SgteEnsembleMegaIteration::generateIterations()
{
    ...
    {
        std::shared_ptr<NOMAD::SgteEnsembleIteration> iteration = std::make_shared<NOMAD::SgteEnsembleIteration>(this, k);
...
void NOMAD::SgteEnsembleMegaIteration::runIterationsAndSetTrialPoints()
{
    std::string s;
    ...
    for (size_t i = 0; i < _iterList.size(); i++)
    {
        ...
        // downcast from Iteration to SgteEnsembleIteration
        std::shared_ptr<NOMAD::SgteEnsembleIteration> iteration = std::dynamic_pointer_cast<NOMAD::SgteEnsembleIteration>(_iterList[i]);
...
void NOMAD::SgteEnsembleMegaIteration::generateTrialPoints()
{
    generateIterations();
...
void NOMAD::SgteEnsembleMegaIteration::filterCache()
{
    ...
    if (nbCandidates > 0)
    {
        ...
        auto modelAlgo = getParentOfType<NOMAD::SgteEnsembleAlgo*>();
        NOMAD::SgteEnsembleFilterCache filter(modelAlgo, nbCandidates);
...
std::ostream& NOMAD::operator<<(std::ostream& os, const NOMAD::SgteEnsembleMegaIteration& megaIteration)
{
...
std::istream& NOMAD::operator>>(std::istream& is, NOMAD::SgteEnsembleMegaIteration& megaIteration)
{
