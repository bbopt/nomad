...
/*---------------------------------------------------------------------------------*/
#ifndef __NOMAD400_SGTE_ENSEMBLE_FILTER_CACHE__
#define __NOMAD400_SGTE_ENSEMBLE_FILTER_CACHE__
...
class SgteEnsembleFilterCache : public Step
{
private:
...
public:
    explicit SgteEnsembleFilterCache(const SgteEnsembleAlgo* modelAlgo,
    ...
    virtual ~SgteEnsembleFilterCache();
...
#endif // __NOMAD400_SGTE_ENSEMBLE_FILTER_CACHE__
