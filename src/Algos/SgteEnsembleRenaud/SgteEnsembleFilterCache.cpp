...
NOMAD::SgteEnsembleFilterCache::~SgteEnsembleFilterCache()
{
    freeSpace();
}


void NOMAD::SgteEnsembleFilterCache::init()
{
...
void NOMAD::SgteEnsembleFilterCache::startImp()
{
    computeInitialValues();
}


bool NOMAD::SgteEnsembleFilterCache::runImp()
{
...
void NOMAD::SgteEnsembleFilterCache::endImp()
{
}


void NOMAD::SgteEnsembleFilterCache::computeInitialValues()
{
...
void NOMAD::SgteEnsembleFilterCache::freeSpace()
{
...
int NOMAD::SgteEnsembleFilterCache::applyMethod(NOMAD::FilterSelectionMethod method)
{
    std::string s;
    size_t nbSgte = _cacheSgte.size();
