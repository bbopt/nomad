...
NOMAD::SgteEnsembleEvaluator::SgteEnsembleEvaluator(const std::shared_ptr<NOMAD::EvalParameters>& evalParams,
                                   const NOMAD::SgteEnsembleAlgo* modelAlgo,
...
// Destructor
NOMAD::SgteEnsembleEvaluator::~SgteEnsembleEvaluator()
{
}


void NOMAD::SgteEnsembleEvaluator::init()
{
...
/*------------------------------------------------------------------------*/
bool NOMAD::SgteEnsembleEvaluator::eval_x(NOMAD::EvalPoint &x,
                                          ...
                                          bool &countEval) const
{
    ...
    size_t nbModels = NOMAD::SgteEnsembleAlgo::getNbModels(_modelFeasibility, nbConstraints);
...
#endif // _OPENMP
    {
        ...
        else if (formulation == NOMAD::SgtelibModelFormulationType::EXTERN)
        {
            throw SGTELIB::Exception(__FILE__, __LINE__,
                                     "SgteEnsembleEvaluator::eval_x: Formulation Extern should not been called in this context.");
        }
        else
        {
            OUTPUT_INFO_START
    ...
    switch (formulation)
    {
        ...
        case NOMAD::SgtelibModelFormulationType::EXTERN:
            OUTPUT_INFO_START
            s = "SgteEnsembleAlgo formulation: " + NOMAD::SgtelibModelFormulationTypeToString(formulation);
            NOMAD::OutputQueue::Add(s, _displayLevel);
            OUTPUT_INFO_END
            break;
    ...
    {
        throw SGTELIB::Exception ( __FILE__ , __LINE__ ,
                                  "SgteEnsembleEvaluator::eval_x: NaN values in pi or pf." );
    }
...
/*----------------------------------------------------------------*/
void NOMAD::SgteEnsembleEvaluator::evalH(const NOMAD::ArrayOfDouble& bbo,
                                         ...
                                         NOMAD::Double &h)
{
    ...
    if ( m != bbot.size() )
    {
        std::string s = "SgteEnsembleEvaluator::evalH() called with an invalid bbo argument";
        std::cerr << s << std::endl;
