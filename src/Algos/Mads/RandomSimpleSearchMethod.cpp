...
/**
 \file   RandomSimpleSearchMethod.cpp
 \brief  A template for simple random search without iteration (implementation)
 \author Christophe Tribes
 \date   2022-05-25
 */

#include "../../Algos/Mads/RandomSimpleSearchMethod.hpp"
#include "../../Algos/RandomAlgo/RandomAlgoSinglePass.hpp"
#include "../../Output/OutputQueue.hpp"

/*-------------------------------------------------------------*/
/*    Random for a simple (no iterations) search method        */
...
void NOMAD::RandomSimpleSearchMethod::init()
{
...
void NOMAD::RandomSimpleSearchMethod::generateTrialPointsFinal()
{
    ...
    // See issue #392
    NOMAD::RandomAlgoSinglePass randomAlgo(this,
