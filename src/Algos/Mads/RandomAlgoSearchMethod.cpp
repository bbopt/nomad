...
void NOMAD::RandomAlgoSearchMethod::init()
{
    ...
    if (randomAlgoSearch)
    {
        ...
        _randomAlgo = std::make_unique<NOMAD::RandomAlgo>(this,
...
bool NOMAD::RandomAlgoSearchMethod::runImp()
{
...
void NOMAD::RandomAlgoSearchMethod::generateTrialPointsFinal()
{
