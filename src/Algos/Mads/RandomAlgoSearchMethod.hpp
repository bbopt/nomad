...
#ifndef __NOMAD_4_6_RANDOMALGOSEARCHMETHOD__
#define __NOMAD_4_6_RANDOMALGOSEARCHMETHOD__
...
/**
 ...
 NOT AVAILABLE AS MADS SEARCH. Kept as a template.
 
 */
class RandomAlgoSearchMethod final : public SearchMethodAlgo
{
private:
    ...
    // TEMPLATE for a new search method: A new Algo must be defined. Create a directory in ../Algos and use the files provided ../Algos/RandomAlgo to create your own Algorithm.
    std::unique_ptr<RandomAlgo> _randomAlgo;
...
public:
     ...
     */
    explicit RandomAlgoSearchMethod(const Step* parentStep )
...
#endif // __NOMAD_4_6_RANDOMALGOSEARCHMETHOD__
