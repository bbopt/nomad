...
#ifndef __NOMAD_4_6_STEP__
#define __NOMAD_4_6_STEP__
...
public:
    ...
    /// Intermediate function to run algo iter callbacks
    virtual void runCallback(const AlgoCallbackType & callbackType,
                             const Step& step,
                             bool &stop);
