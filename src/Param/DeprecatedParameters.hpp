...
/*---------------------------------------------------------------------------------*/
#ifndef __NOMAD_4_0_DEPRECATEDPARAMETERS__
#define __NOMAD_4_0_DEPRECATEDPARAMETERS__
...
*/
class DeprecatedParameters final : public Parameters
{
public:
    /// Constructor
...
#endif // __NOMAD_4_0_DEPRECATEDPARAMETERS__
